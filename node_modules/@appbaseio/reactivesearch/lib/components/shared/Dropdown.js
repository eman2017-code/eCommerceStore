		...
		return _react2.default.createElement(_downshift2.default, {
			...
			render: function render(_ref) {
				var getButtonProps = _ref.getButtonProps,
				    ...
				    rest = _objectWithoutProperties(_ref, ['getButtonProps', 'getItemProps', 'isOpen', 'highlightedIndex']);
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_this2.props.customLabelRenderer ? _this2.props.customLabelRenderer(selectedItem) : _react2.default.createElement(
							'div',
							null,
					...
					hasCustomRenderer ? customRenderer(itemsToRender, _extends({
						getButtonProps: getButtonProps, getItemProps: getItemProps, isOpen: isOpen, highlightedIndex: highlightedIndex }, rest)) : isOpen && itemsToRender.length ? _react2.default.createElement(
						'ul',
						{
