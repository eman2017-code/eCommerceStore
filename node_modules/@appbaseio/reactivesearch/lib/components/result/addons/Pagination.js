...
var Pagination = function (_React$PureComponent) {
	...
	Pagination.prototype.render = function render() {
		...
		return _react2.default.createElement(
			...
			showEndPage && currentPage >= Math.floor(pages / 2) + !!(pages % 2) ? _react2.default.createElement(
				'span',
				null,
				'...'
			) : null,
			this.buildIntermediatePaginationDom(),
			showEndPage && pages > 2 && currentPage <= totalPages - Math.ceil(pages * 0.75) ? _react2.default.createElement(
				'span',
				null,
				'...'
			) : null,
