        ...
        <div className="container-fluid">
          <div className="row">
            <div className="col-xl-3 col-md-6 xl-50">
              <div className="card order-graph sales-carousel"></div>
            </div>
            <div className="col-xl-3 col-md-6 xl-50">
                            ...
                            <table className="table table-bordernone">
                              ...
                              <tbody>
                                <tr>
                                  ...
                                  <td className="counter">$120.00</td>
                                </tr>
                                <tr>
                                  <td>2</td>
                                  <td className="digits">
                                ...
                                <tr>
                                  ...
                                  <td className="counter">$240.00</td>
                                </tr>
                                <tr>
                                  <td>4</td>
                                  <td className="digits">
